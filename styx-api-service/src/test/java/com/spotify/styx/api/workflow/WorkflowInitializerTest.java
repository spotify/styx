...
public class WorkflowInitializerTest {
  ...
  public void shouldFailToReadWorkflow() throws Exception {
    ...
    try {
      workflowInitializer.inspectChangeAndStore(HOURLY_WORKFLOW);
      fail();
  ...
  public void shouldFailComputeNextTrigger() throws Exception {
    ...
    workflowInitializer.inspectChangeAndStore(HOURLY_WORKFLOW_WITH_INVALID_OFFSET);
  }
  ...
  public void shouldFailToUpdateNextNaturalTrigger() throws Exception {
    ...
    try {
      workflowInitializer.inspectChangeAndStore(HOURLY_WORKFLOW_WITH_VALID_OFFSET);
      fail();
    } catch (RuntimeException e) {

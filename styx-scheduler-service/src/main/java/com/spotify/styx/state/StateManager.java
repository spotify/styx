...
public interface StateManager extends Closeable {
   ...
   */
  CompletionStage<RunState> trigger(WorkflowInstance workflowInstance, Trigger trigger,
   ...
   * @throws IsClosedException if the state receiver is closed and can not handle events
   */
  CompletionStage<RunState> receive(Event event, long counter) throws IsClosedException;
